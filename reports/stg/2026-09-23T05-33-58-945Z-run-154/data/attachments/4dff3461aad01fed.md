...
- Name: regression/pages/solutions.page.spec.ts >> should load solutions page with correct title and heading @allure.label.epic:Regression @allure.label.feature:Pages @allure.label.story:solutions @allure.label.severity:critical @smoke @regression @critical
- Location: tests/regression/pages/solutions.page.spec.ts:11:5

# Error details

```
Error: Unexpected status for /solutions
  ...
  - main [ref=e2]:
    - region "This page doesn’t exist" [ref=e3]:
      ...
      - generic "HTTP status, error code, and request ID" [ref=e7]:
        ...
        - paragraph [ref=e9]: sfo1::4cnqb-1790141501610-9d2e7c6d84b2
