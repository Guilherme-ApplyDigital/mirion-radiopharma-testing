...
- Name: regression/pages/isotope-producers-radiopharmacies.page.spec.ts >> should load isotope producers radiopharmacies page with correct title and heading @allure.label.epic:Regression @allure.label.feature:Pages @allure.label.story:isotope-producers-radiopharmacies @allure.label.severity:critical @smoke @regression @critical
- Location: tests/regression/pages/isotope-producers-radiopharmacies.page.spec.ts:11:5

# Error details

```
Error: Unexpected status for /isotope-producers-radiopharmacies
  ...
  - main [ref=e2]:
    - region "This page doesn’t exist" [ref=e3]:
      ...
      - generic "HTTP status, error code, and request ID" [ref=e7]:
        ...
        - paragraph [ref=e9]: sfo1::gkbpr-1790141500079-836af6d84524
