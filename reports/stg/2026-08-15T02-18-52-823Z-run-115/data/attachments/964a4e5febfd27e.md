...
- Name: regression/pages/hospitals-clinical-sites.page.spec.ts >> should load hospitals clinical sites page with correct title and heading @allure.label.epic:Regression @allure.label.feature:Pages @allure.label.story:hospitals-clinical-sites @allure.label.severity:critical @smoke @regression @critical
- Location: tests/regression/pages/hospitals-clinical-sites.page.spec.ts:11:5

# Error details

```
Error: Unexpected status for /hospitals-clinical-sites
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::phcjl-1786760207077-51bdd3c6bbeb`"
