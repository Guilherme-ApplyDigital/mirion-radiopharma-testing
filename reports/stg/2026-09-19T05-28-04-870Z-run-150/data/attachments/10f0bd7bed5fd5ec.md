...
- Name: regression/pages/home.page.spec.ts >> should load home page with correct title and heading @allure.label.epic:Regression @allure.label.feature:Pages @allure.label.story:home @allure.label.severity:critical @smoke @regression @critical
- Location: tests/regression/pages/home.page.spec.ts:11:5

# Error details

```
Error: Unexpected status for /
  ...
  - main [ref=e2]:
    - region "This page doesn’t exist" [ref=e3]:
      ...
      - generic "HTTP status, error code, and request ID" [ref=e7]:
        ...
        - paragraph [ref=e9]: iad1::2vb2s-1789795560933-19606ecf0bc0
