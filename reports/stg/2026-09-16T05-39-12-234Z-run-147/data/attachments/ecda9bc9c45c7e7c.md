...
- Name: regression/content/accessibility-basics.spec.ts >> Accessibility basics >> semantic contracts >> should satisfy baseline accessibility checks on drug-owners-developers @allure.label.epic:Regression @allure.label.feature:Accessibility @allure.label.story:BaselineA11y @allure.label.severity:normal @regression @content
  ...
  - main [ref=e2]:
    - region "This page doesn’t exist" [ref=e3]:
      ...
      - generic "HTTP status, error code, and request ID" [ref=e7]:
        ...
        - paragraph [ref=e9]: iad1::8mkzf-1789536588649-bac793b37488
