...
- Name: regression/content/accessibility-basics.spec.ts >> Accessibility basics >> semantic contracts >> should satisfy baseline accessibility checks on home @allure.label.epic:Regression @allure.label.feature:Accessibility @allure.label.story:BaselineA11y @allure.label.severity:normal @regression @content
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::tmk8l-1786244285789-86cb3bb9b1ad`"
