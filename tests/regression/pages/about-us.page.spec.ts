...
const auditedPage = AUDITED_PAGES.find((page) => page.key === 'about-us');

if (!auditedPage) {
  throw new Error('Missing route config for about-us');
}

test(
  'should load about us page with correct title and heading '
    + '@allure.label.epic:Regression '
    + '@allure.label.feature:Pages '
    + '@allure.label.story:about-us '
